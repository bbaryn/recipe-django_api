...
def sample_tag(user, name='Main course'):
    ...
    return Tag.objects.create(user=user, name=user)


def sample_ingredient(user, name='Cinnamon'):
    """Create and return a smaple ingredient"""
    return Ingredients.objects.create(user=user, name=user)
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test retrieving recipes from user"""
    ...
    def test_view_recipe_detail(self):
        ...
        serializer = RecipeDetailSerilizer(recipe)
        self.assertEqual(res.data, serializer.data)
    ...
    def test_crete_recipe_with_tags(self):
        """Tag creating a recipe with tags"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning returning recipes with specific tags"""
